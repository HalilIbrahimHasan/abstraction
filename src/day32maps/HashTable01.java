...
public class HashTable01 {
    ...
    public static void main(String[] args) {
        ...
        //ht1.put("value", null); cannot be accepted
        ...
        System.out.println(ht1.containsValue(500));//if we want to check the value for entries, then if value exists, it returns true
        ...
        System.out.println(ht1.size() == 0);// this is not best way to check wether your map has elements or not
